...
const translations = {
  ...
  zh: {
    ...
    "nav.contact": "联系",
    "hero.eyebrow": "个人网站",
    "hero.title": "C.T.Luxe 的个人主页",
    "hero.copy": "一个简洁、有质感的个人主页。",
    "hero.about": "了解我",
    "hero.contact": "联系我",
    "about.label": "关于",
    "about.title": "你好，我是 C.T.Luxe。",
...
const applyLanguage = (language, remember = false) => {
  ...
  document.title = currentLanguage === "zh" ? "C.T.Luxe | 个人主页" : "C.T.Luxe | Sitio personal";
